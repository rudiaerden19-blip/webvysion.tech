...
const content = {
  nl: {
    ...
    sections: [
      { heading: '1. Wie zijn wij?', body: 'WebVysion (Vysion IT, Siberièstraat 24, 3900 Pelt) is verantwoordelijk voor de verwerking van persoonsgegevens zoals beschreven in dit privacybeleid. Contact: info@webvysion.tech' },
      ...
      { heading: '5. Uw rechten (GDPR)', body: 'U heeft het recht op inzage, correctie, verwijdering, beperking van verwerking en overdraagbaarheid van uw gegevens. U kunt uw toestemming te allen tijde intrekken. Stuur uw verzoek naar info@webvysion.tech.' },
  ...
  fr: {
    ...
    sections: [
      { heading: '1. Qui sommes-nous?', body: 'WebVysion (Vysion IT, Siberièstraat 24, 3900 Pelt) est responsable du traitement des données personnelles décrit dans cette politique. Contact: info@webvysion.tech' },
      ...
      { heading: '5. Vos droits (RGPD)', body: 'Vous avez le droit d\'accès, de rectification, d\'effacement, de limitation du traitement et de portabilité de vos données. Envoyez votre demande à info@webvysion.tech.' },
  ...
  de: {
    ...
    sections: [
      { heading: '1. Wer sind wir?', body: 'WebVysion (Vysion IT, Siberièstraat 24, 3900 Pelt) ist verantwortlich für die Verarbeitung personenbezogener Daten gemäß dieser Datenschutzerklärung. Kontakt: info@webvysion.tech' },
      ...
      { heading: '5. Ihre Rechte (DSGVO)', body: 'Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung und Datenübertragbarkeit. Senden Sie Ihre Anfrage an info@webvysion.tech.' },
  ...
  en: {
    ...
    sections: [
      { heading: '1. Who are we?', body: 'WebVysion (Vysion IT, Siberièstraat 24, 3900 Pelt) is responsible for the processing of personal data as described in this privacy policy. Contact: info@webvysion.tech' },
      ...
      { heading: '5. Your rights (GDPR)', body: 'You have the right to access, correction, deletion, restriction of processing and data portability. Send your request to info@webvysion.tech.' },
