...
export const metadata: Metadata = {
  ...
  keywords: ['SaaS development', 'web applicaties', 'mobiele apps iOS Android', 'maatwerk website', 'MVP startup', 'software developer België'],
  openGraph: {
    title: 'Diensten | WebVysion — SaaS, Web & Mobile Development',
    description: 'Van SaaS platform tot mobiele app — wij bouwen complete softwareproducten van idee tot werkend systeem. Development team uit België.',
