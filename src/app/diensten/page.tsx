  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6" style={{ backgroundColor: '#e3e3e3' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.6 }} className="bg-white rounded-2xl border border-slate-200 shadow-[0_12px_60px_rgba(0,0,0,0.40)] p-10 text-center">
