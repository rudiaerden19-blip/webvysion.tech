      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {services.map((service, i) => (
            <motion.div key={service.id} initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1, duration: 0.6 }} className="group bg-white rounded-2xl border border-slate-200 shadow-[0_32px_80px_-8px_rgba(0,0,0,0.40)] hover:shadow-[0_40px_90px_-8px_rgba(0,0,0,0.48)] hover:border-slate-300 transition-all overflow-hidden">
