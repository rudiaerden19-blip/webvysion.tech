...
const cardScales = [1, 0.98, 0.96, 0.94, 0.92, 0.90]
...
export default function ProjectenPage() {
  ...
  return (
    <div style={{ backgroundColor: '#e3e3e3', fontFamily: 'system-ui' }}>
      <div style={{ maxWidth: '1100px', margin: 'auto', paddingTop: '120px', paddingBottom: '200px', paddingLeft: '24px', paddingRight: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
                  <div style={{ flex: 1, minWidth: '280px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
                      ...
                      <div>
                        <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#0F172A', marginBottom: '4px' }}>{pd?.name ?? project.name}</h2>
                        <p style={{ fontSize: '13px', fontWeight: 600, color: '#2563EB' }}>{pd?.tagline ?? project.tagline}</p>
                      </div>
                    </div>
                  ...
                  <div style={{ width: '240px', flexShrink: 0 }}>
                    <p style={{ fontSize: '11px', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '12px' }}>{tr.features}</p>
