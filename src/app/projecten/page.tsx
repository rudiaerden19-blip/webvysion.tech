      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {projects.map((project, i) => {
            ...
            return (
            <motion.div key={project.id} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1, duration: 0.6, ease: "easeOut" }} className="group bg-white rounded-2xl border border-slate-200 p-8 hover:border-slate-300 hover:shadow-md transition-all duration-300">
