...
export default function ProjectenPage() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-40 px-6" style={{ backgroundColor: '#e3e3e3' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {projects.map((project, i) => {
            ...
            return (
              <motion.div key={project.id} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1, duration: 0.6, ease: "easeOut" }} className="bg-white rounded-2xl border border-slate-200 shadow-[0_12px_60px_rgba(0,0,0,0.40)] hover:shadow-[0_24px_80px_rgba(0,0,0,0.40)] hover:border-slate-300 p-8 transition-shadow duration-300">
