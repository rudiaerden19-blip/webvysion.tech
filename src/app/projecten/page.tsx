                ...
                <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-24 h-24 rounded-2xl shrink-0 overflow-hidden bg-[#0F1623] flex items-center justify-center" style={{ border: `1px solid ${project.color}30` }}>
                    ...
                    <div className="flex flex-wrap gap-3 mt-5">
                      {'url' in project && project.url && (
                        <a href={project.url as string} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-all hover:opacity-80" style={{ color: project.color, borderColor: `${project.color}40`, background: `${project.color}0D` }}>
                          <ExternalLink size={15} />{tr.visit}
                        </a>
                      )}
                      {'github' in project && project.github && (
                        <a href={project.github as string} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border border-[#1A2332] bg-[#0F1623] text-[#8899B0] hover:text-[#E8EDF5] hover:border-[#243447] transition-all">
